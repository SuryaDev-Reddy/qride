...
public class ReadDataHandlerImplTest {
  ...
  public void getCarsInLocationNormalCase() {
    ...
    assertEquals("# of available cars expected to be within the radius", 41, carStatusList.size());
    ...
    //  We can provide you a utility function that calculates distance between two lat/long in java.
