...
public class GeoUtils {
  // TIP: Feel free to use this function to calculate distance between two geolocations.
  public static Float getDistanceBetweenLocationsInKms(
      GeoLocation sourceLocation, GeoLocation destinationLocation) {
    return (float)
        distance(
