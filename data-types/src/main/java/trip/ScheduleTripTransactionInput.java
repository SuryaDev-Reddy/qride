...
public class ScheduleTripTransactionInput {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ScheduleTripTransactionInput)) {
      return false;
    }
    ScheduleTripTransactionInput that = (ScheduleTripTransactionInput) o;
    return carType == that.carType &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(carType, tripPrice, sourceLocation, destinationLocation);
  }
